...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<Map<String, dynamic>> _fetchDashboard() async {
    // Si es admin, pasar el hotelId
    if (AuthService.isAdmin) {
      final hotelId = HotelSession.hotelId;
      if (hotelId == null) throw 'Selecciona un hotel primero';
      return _api.getDashboardKpis(hotelId: hotelId);
    }
    return _api.getDashboardKpis();
  }
